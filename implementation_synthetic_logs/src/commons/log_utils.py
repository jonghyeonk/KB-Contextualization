...
class LogData:
    ...
    def __init__(self, log_path: Path):
        ...
        train_ids = self.log[self.case_name_key].unique().tolist()
        ...
        trace_ids = merged[self.case_name_key].unique().tolist()
        self.log = merged
        ...
        dict_cv_train = filterByKey(train_ids)
