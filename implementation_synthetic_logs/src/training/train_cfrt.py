...
def _build_model(max_len, num_features, target_chars, target_chars_group, models_folder):
    ...
    model = Model(main_input, [activity_output, group_output, time_output, outcome_output])
...
def train(log_data: LogData, models_folder: str):
    ...
    for fold in range(shared.folds):
        ...
        checkpoint_name = create_checkpoints_path(log_data.log_name.value, models_folder, fold, 'CFRT')
